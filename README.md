...
SaaS 身份平台 · MSW v2 mock 层（消费 `saas-identity-platform-shared` 产出的 OpenAPI）。

## 技术栈

MSW (Mock Service Worker) v2 + Node + TypeScript + Vitest。
...
> "用 deepwiki 查一下 saas-identity-platform-shared 仓关于 OAuth 2.0 授权端点的章节"
